...
class InceptionV3(nn.Module):
    def __init__(self):
        ...
        # Inception blocks
        self.inception_a1 = InceptionA(64, pool_features=32)
        self.inception_a2 = InceptionA(256, pool_features=64)
        self.inception_b1 = InceptionB(288)
        self.inception_c1 = InceptionC(768, channels_7x7=128)
        self.inception_c2 = InceptionC(768, channels_7x7=160)
